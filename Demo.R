...
# select one next generation sequencing (NGS) sample per patient
...
# Create gene binary matrix with 1 row per sample, 1 column pre gene -----
# for the gene columns: 
#       1 = gene is altered (mutation, fusion, or copy number alteration)
#       0 = gene is unaltered (no mutation, fusion, or copy number alteration)
#       NA = gene was not tested on sequencing panel; unknown if gene is altered
